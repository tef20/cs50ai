...
class NimAI():
    ...
    def choose_action(self, state, epsilon=True):
        ...
        if epsilon and random.choices([1, 0], [self.epsilon, (1-self.epsilon)])[0]:
            # choose randomly
            ...
            for action in available_actions:
                action_values[action] = self.get_q_value(tuple(state), action)
            choice = max(action_values, key=action_values.get)
